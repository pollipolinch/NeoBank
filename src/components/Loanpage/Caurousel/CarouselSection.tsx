    ...
    <section className={style.caurousel}>
      ...
      <div>
        {selectedTab === Tab[0].id && (
          <div data-testid="about-section" className={style.caurousel__about}>
            <div className={style.caurousel__about_mini}>
              <img
                ...
                alt="icon"
              />
              <h4 className={style.caurousel__about_title}>Up to 50 000 ₽</h4>
            ...
            >
              <img
                ...
                alt="icon"
              />
              <h4 className={style.caurousel__about_title}>Up to 160 days</h4>
              <p className={style.caurousel__about_text}>
            ...
            <div className={style.caurousel__about_mini}>
              <img
                ...
                alt="icon"
              />
              <h4 className={style.caurousel__about_title}>Free delivery</h4>
              <p className={style.caurousel__about_text}>
                We will deliver your card by courier at a convenient place and
                time for you
              </p>
            </div>
            <div
            ...
            >
              <img
                ...
                alt="icon"
              />
              <h4 className={style.caurousel__about_title}>Up to 12 months</h4>
              <p className={style.caurousel__about_text}>
            ...
            <div className={style.caurousel__about_maxi}>
              ...
              <p className={style.caurousel__about_text}>
                At any ATM. Top up your credit card for free with cash or
        ...
        {selectedTab === Tab[1].id && (
          <div data-testid="rates-section" className={style.caurousel__rates}>
            <div className={style.caurousel__rates_info}>
              <h4 className={style.caurousel__rates_title}>Card currency</h4>
            ...
            <div className={style.caurousel__rates_info}>
              ...
              <p className={style.caurousel__rates_text}>0% up to 160 days</p>
            </div>
            <Divider />
            <div className={style.caurousel__rates_info}>
              <h4 className={style.caurousel__rates_title}>Payment system</h4>
              <p className={style.caurousel__rates_text}>Mastercard, Visa</p>
            </div>
            <Divider />
            <div className={style.caurousel__rates_info}>
              <h4 className={style.caurousel__rates_title}>
              ...
              <p className={style.caurousel__rates_text}>600 000 ₽</p>
            </div>
            <Divider />
            <div className={style.caurousel__rates_info}>
              <h4 className={style.caurousel__rates_title}>
            ...
            <div className={style.caurousel__rates_info}>
              ...
              <p className={style.caurousel__rates_text}>15 000 ₽</p>
            </div>
            <Divider />
            <div className={style.caurousel__rates_info}>
              <h4 className={style.caurousel__rates_title}>
              ...
              <p className={style.caurousel__rates_text}>
                60 ₽ — SMS or push notifications 0 ₽ — card statement,
                information about transactions in the online bank
              </p>
            </div>
          </div>
        )}
        {selectedTab === Tab[2].id && (
          <div
            data-testid="cashback-section"
            className={style.caurousel__cashback}
          >
            <div className={style.caurousel__cashback_back}>
              ...
              <h4 className={style.caurousel__cashback_number}>5%</h4>
            </div>
            <div
              className={classNames(
            ...
            <div className={style.caurousel__cashback_back}>
              ...
              <h4 className={style.caurousel__cashback_number}>2%</h4>
            </div>
            <div
              className={classNames(
                style.caurousel__cashback_back,
            ...
            >
              ...
              <h4 className={style.caurousel__cashback_number}>1%</h4>
            </div>
            <div className={style.caurousel__cashback_back}>
              <p className={style.caurousel__cashback_info}>
                Shopping in online stores
              </p>
              <h4 className={style.caurousel__cashback_number}>up to 3%</h4>
            </div>
            <div
              className={classNames(
                style.caurousel__cashback_back,
            ...
            >
              ...
              <h4 className={style.caurousel__cashback_number}>30%</h4>
            </div>
          </div>
        )}
        {selectedTab === Tab[3].id && (
          <div data-testid="faq-section" className={style.caurousel__accordion}>
