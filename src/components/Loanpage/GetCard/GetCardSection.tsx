        ...
        <div className={style.getCard__container_info}>
          <div className={style.getCard__container_info_left}>
            <div className={style.getCard__container_steps}>
              ...
              <p className={style.getCard__container_stepNum}>Step 1 of 5</p>
            </div>
            <div className={style.getCard__amount}>
              <h3 className={style.getCard__container_text}>Select amount</h3>
              <p className={style.getCard__container_text}>{amount}</p>
              <input
              ...
              <div className={style.getCard__container_nums}>
                <p className={style.getCard__amount_num}>15 000</p>
                <p className={style.getCard__amount_num}>600 000</p>
              </div>
            </div>
          </div>
        ...
        <div className={style.getCard__select}>
          ...
          <form onSubmit={handleSubmit(handleSubmitForm)}>
            <div className={style.getCard__select_container}>
              <div>
                <label className={style.getCard__select_label} htmlFor="last">
                  Your last name{" "}
                  <span className={style.getCard__select_stars}>*</span>
                </label>
                ...
                {errors.lastName && (
                  <p className={style.getCard__errors}>Enter your last name</p>
                )}
              </div>
              <div>
                <label className={style.getCard__select_label} htmlFor="first">
                  Your first name{" "}
                  <span className={style.getCard__select_stars}>*</span>
                </label>
                <div className={style.getCard__input_container}>
                ...
                {errors.firstName && (
                  <p className={style.getCard__errors}>Enter your first name</p>
                )}
              </div>
              <div>
                <label
              ...
              <div>
                <label className={style.getCard__select_label} htmlFor="select">
                  Select term{" "}
                  <span className={style.getCard__select_stars}>*</span>
                </label>
                <select
              ...
              <div>
                <label className={style.getCard__select_label} htmlFor="email">
                  Your email{" "}
                  <span className={style.getCard__select_stars}>*</span>
                </label>
                <div className={style.getCard__input_container}>
              ...
              <div>
                <label className={style.getCard__select_label} htmlFor="birth">
                  Your date of birth{" "}
                  <span className={style.getCard__select_stars}>*</span>
                </label>
                <div className={style.getCard__input_container}>
              ...
              <div>
                <label className={style.getCard__select_label} htmlFor="series">
                ...
                <div className={style.getCard__input_container}>
                  ...
                  {touchedFields.passportSeries && !errors.passportSeries && (
                    <SuccessIcon />
                  )}
                </div>
                {errors.passportSeries && (
              ...
              <div>
                <label className={style.getCard__select_label} htmlFor="number">
                ...
                <div className={style.getCard__input_container}>
                  ...
                  {touchedFields.passportNumber && !errors.passportNumber && (
                    <SuccessIcon />
                  )}
                </div>
                {errors.passportNumber && (
            ...
            <div className={style.getCard__button_container}>
              <button type="submit" className={style.getCard__button}>
                Continue
              </button>
            </div>
          </form>
