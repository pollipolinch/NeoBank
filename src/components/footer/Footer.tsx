    ...
    return (
        ...
        <div className={style.footer__container}>
            <div className={style.footer__contacts}>
                <img className={style.footer__logo} src={logo} alt="logo-neo"/>
                <ul className={style.footer__address}>
                    <li><a className={style.footer__address_phone} href="tel:+74959842513">+7 (495) 984 25 13</a></li>
                    <li><a className={style.footer__address_email} href="mailto:info@neoflex.ru">info@neoflex.ru</a></li>
                </ul>
            </div>
            <div>
                <ul className={style.footer__list}>
                    ...
                    <li className={style.footer__link}>Quality of service</li>
                    ...
                    <li className={style.footer__link}>Business and processes</li>
                    <li className={style.footer__link}>Compliance and business ethics</li>
                </ul>
            </div>
            <div className={style.footer__line}></div>
            <p className={style.footer__text}>We use cookies to personalize our services and improve the user experience of our
