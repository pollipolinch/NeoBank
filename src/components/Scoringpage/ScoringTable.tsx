    ...
    <section>
      <div className={style.scoring__container}>
        <div className={style.scoring__container_info}>
          ...
          <p className={style.scoring__container_stepNum}>Step 2 of 5</p>
        </div>
        <div className={style.scoring__select}>
          <form onSubmit={handleSubmit(handleSubmitForm)}>
            <div className={style.scoring__select_container}>
              <div>
                <label className={style.scoring__select_label} htmlFor="gender">
                  What's your gender{" "}
                  <span className={style.scoring__select_stars}>*</span>
                </label>
                <select
              ...
              <div>
                ...
                <div className={style.scoring__input_container_maxi}>
                  <input
                    className={classNames(
                  ...
                  {touchedFields.passportIssueDate &&
                    !errors.passportIssueDate && <SuccessIcon />}
                </div>
                {errors.passportIssueDate && (
                  <p className={style.scoring__errors}>
              ...
              <div>
                ...
                <div className={style.scoring__input_container_maxi}>
                  ...
                  />
                  {errors.passportIssueBranch && <ErrorIcon />}
                  {touchedFields.passportIssueBranch &&
                    !errors.passportIssueBranch && <SuccessIcon />}
                </div>
                {errors.passportIssueBranch && (
                  <p className={style.scoring__errors}>
            ...
            <p className={style.scoring__container_text}>Employment</p>
            <div className={style.scoring__select_container}>
              <div>
                <label
                  className={style.scoring__select_label}
              ...
              <div>
                ...
                <div className={style.scoring__input_container}>
                  ...
                  {touchedFields.employerINN && !errors.employerINN && (
                    <SuccessIcon />
                  )}
                </div>
                {errors.employerINN && (
              ...
              <div>
                <label className={style.scoring__select_label} htmlFor="salary">
                  Your salary{" "}
                  <span className={style.scoring__select_stars}>*</span>
                </label>
                <div className={style.scoring__input_container}>
                  ...
                  {touchedFields.salary && !errors.salary && <SuccessIcon />}
                </div>
                {errors.salary && (
                  <p className={style.scoring__errors}>Enter your salary</p>
                )}
              </div>
              <div>
                <label
              ...
              <div>
                ...
                <div className={style.scoring__input_container}>
                  ...
                  />
                  {errors.workExperienceTotal && <ErrorIcon />}
                  {touchedFields.workExperienceTotal &&
                    !errors.workExperienceTotal && <SuccessIcon />}
                </div>
                {errors.workExperienceTotal && (
                  <p className={style.scoring__errors}>
              ...
              <div>
                ...
                <div className={style.scoring__input_container}>
                  ...
                  />
                  {errors.workExperienceCurrent && <ErrorIcon />}
                  {touchedFields.workExperienceCurrent &&
                    !errors.workExperienceCurrent && <SuccessIcon />}
                </div>
                {errors.workExperienceCurrent && (
                  <p className={style.scoring__errors}>
            ...
            <div className={style.scoring__button_container}>
              <button type="submit" className={style.scoring__button}>
                Continue
              </button>
            </div>
          </form>
